<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="AdvisorsView.aspx.cs" Inherits="Assignment.AdvisorsView" %>
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Mode">
                    <EditItemTemplate>
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ServicesContext %>" SelectCommand="SELECT DISTINCT [Mode] FROM [AdvisorHire]"></asp:SqlDataSource>
                    </EditItemTemplate>
                    <ItemTemplate>
