<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="VideosView.aspx.cs" Inherits="Assignment.VideosView" %>
...
&nbsp;&nbsp;&nbsp;
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ServicesContext %>" SelectCommand="SELECT * FROM [EducationVideo]"></asp:SqlDataSource>
