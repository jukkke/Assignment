<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="ProductCustView.aspx.cs" Inherits="Assignment.ProductCustView" %>
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="Product Category">
                <EditItemTemplate>
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ServicesContext %>" SelectCommand="SELECT DISTINCT [Category] FROM [AvailableCustomization] WHERE ([Category] IS NOT NULL)"></asp:SqlDataSource>
                </EditItemTemplate>
                <ItemTemplate>
            ...
            <asp:TemplateField HeaderText="Colour">
                <EditItemTemplate>
                    ...
                    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:ServicesContext %>" SelectCommand="SELECT DISTINCT [Colour] FROM [AvailableCustomization]"></asp:SqlDataSource>
                </EditItemTemplate>
                <ItemTemplate>
            ...
            <asp:TemplateField HeaderText="Scent">
                <EditItemTemplate>
                    ...
                    <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:ServicesContext %>" SelectCommand="SELECT DISTINCT [Scent] FROM [AvailableCustomization] WHERE ([Scent] IS NOT NULL)"></asp:SqlDataSource>
                </EditItemTemplate>
                <ItemTemplate>
